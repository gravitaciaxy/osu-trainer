...
FILES="analyze.py coach.py collector.py config.py feedback.py i18n.py labels.py liquipedia.py net.py osu_api.py pools.py replay.py skills.py trainer.py ui.py index.html data"
