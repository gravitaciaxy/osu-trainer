...
По желанию — прогреть базу: заранее узнать названия, жанры и теги всех турнирных карт, чтобы подбор
по турнирам не запрашивал их по одной (около 6 часов в фоне, один раз). Звёзды подбор всё равно
каждый раз берёт свежие с osu.direct, по 100 карт за запрос:
