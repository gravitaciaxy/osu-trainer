...
mkdir -p "$APP/cache"
for f in analyze.py coach.py collector.py config.py feedback.py i18n.py liquipedia.py net.py osu_api.py pools.py replay.py skills.py trainer.py ui.py index.html; do
    cp "$SRC/$f" "$APP/$f"
done
rm -rf "$APP/data"
